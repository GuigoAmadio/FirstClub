...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      id="Projeto First"
      className="relative flex flex-col w-screen h-screen items-center justify-center gap-5 pt-48 mb-20"
    >
      ...
      <div className="bg-[#214b97] absolute top-[22rem] -z-1  0 right-[23rem] h-[15rem] w-[15rem] rounded-full blur-[10rem] sm:w-[20rem] dark:bg-[#676394]"></div>
      ...
      <h1 className="text-gradient font-bungee text-6xl">Be #F1rst1</h1>
      <h2 className="text-gradient font-alfa text-4xl text-center">
